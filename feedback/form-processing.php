...
define('EMAIL_SETTINGS', [
  'addresses' => ['spb.jara@gmail.com'], // кому необходимо отправить письмо
  'from' => ['no-reply@domain.com', 'spb-jara.net'], // от какого email и имени необходимо отправить письмо
